# Planner Pair Draft: 30 Person-Mention Animation Examples

Each pair follows your requested pattern:
- Input includes `about` and `aim` in media.
- Output enforces: when person is mentioned, show image with requested animation.
- Output enforces: image fills horizontal bounds with **uniform scale** (no stretch).

## Example 1
Input:
- Instruction: cinematic history short
- Transcript: "Julius Caesar changed Rome. Julius Caesar was assassinated."
- Media image_1 about: "this is Julius Caesar" aim: "want the animation of bouncing the image"
- Background: grain_vignette, Design: clean_caption

Output:
- Rule: every time "Julius Caesar" appears, show `image_1` with `bounce`.
- Placement: centered top/mid, keep captions in lower safe zone.
- Sizing: scale uniformly until image touches left/right video bounds; preserve aspect ratio.

## Example 2
Input:
- Transcript: "Albert Einstein redefined physics. Einstein inspired generations."
- Media image_1 about: "this is Albert Einstein" aim: "want pop animation on image"
- Background: clean_black, Design: meme_caption

Output:
- Trigger mentions: "Albert Einstein", "Einstein" -> show `image_1` with `pop`.
- Sizing: width-fill using equal `scale_x`/`scale_y`, never stretched.

## Example 3
Input:
- Transcript: "Nikola Tesla imagined a wireless world. Tesla changed power systems."
- Media image_1 about: "this is Nikola Tesla" aim: "want shake animation for reveal"
- Background: roman_columns, Design: clean_caption

Output:
- Mention trigger: each "Nikola Tesla"/"Tesla" -> reveal `image_1` with `shake`.
- Sizing: uniform upscale to horizontal boundaries.

## Example 4
Input:
- Transcript: "Marie Curie discovered radium. Curie changed science."
- Media image_1 about: "this is Marie Curie" aim: "want wiggle animation"
- Background: calendar_dark, Design: clean_caption

Output:
- Mention trigger: "Marie Curie"/"Curie" -> show `image_1` with `wiggle`.
- Sizing: fit-to-width with locked aspect ratio.

## Example 5
Input:
- Transcript: "Ada Lovelace wrote the first algorithm. Ada inspired computing."
- Media image_1 about: "this is Ada Lovelace" aim: "want slide_up animation"
- Background: clean_black, Design: meme_caption

Output:
- Mention trigger: "Ada Lovelace"/"Ada" -> `image_1` enters with `slide_up`.
- Sizing: cover full horizontal span using uniform scale.

## Example 6
Input:
- Transcript: "Leonardo da Vinci was a polymath. Leonardo painted the Mona Lisa."
- Media image_1 about: "this is Leonardo da Vinci" aim: "want slide_left reveal"
- Background: grain_vignette, Design: clean_caption

Output:
- Mention trigger: "Leonardo da Vinci"/"Leonardo" -> show `image_1` with `slide_left`.
- Sizing: no stretch; scale both axes equally until width is filled.

## Example 7
Input:
- Transcript: "Mahatma Gandhi led nonviolent resistance. Gandhi inspired movements."
- Media image_1 about: "this is Mahatma Gandhi" aim: "want fade_in reveal"
- Background: clean_black, Design: clean_caption

Output:
- Mention trigger: "Mahatma Gandhi"/"Gandhi" -> show `image_1` with `fade_in`.
- Sizing: horizontal-boundary fill with uniform scaling.

## Example 8
Input:
- Transcript: "Nelson Mandela fought apartheid. Mandela became a global symbol."
- Media image_1 about: "this is Nelson Mandela" aim: "want subtle zoom in"
- Background: roman_columns, Design: meme_caption

Output:
- Mention trigger: "Nelson Mandela"/"Mandela" -> show `image_1` with `subtle_zoom`.
- Sizing: equal scaling, width filled, preserve ratio.

## Example 9
Input:
- Transcript: "Amelia Earhart flew solo across the Atlantic. Earhart broke barriers."
- Media image_1 about: "this is Amelia Earhart" aim: "want pulse animation"
- Background: calendar_dark, Design: clean_caption

Output:
- Mention trigger: "Amelia Earhart"/"Earhart" -> show `image_1` with `pulse`.
- Sizing: full horizontal coverage via uniform upscale.

## Example 10
Input:
- Transcript: "Thomas Edison popularized electric light. Edison held many patents."
- Media image_1 about: "this is Thomas Edison" aim: "want stomp effect"
- Background: grain_vignette, Design: meme_caption

Output:
- Mention trigger: "Thomas Edison"/"Edison" -> show `image_1` with `stomp`.
- Sizing: width-fill, same scale on both axes.

## Example 11
Input:
- Transcript: "Abraham Lincoln preserved the Union. Lincoln gave the Gettysburg Address."
- Media image_1 about: "this is Abraham Lincoln" aim: "want bounce animation"
- Background: clean_black, Design: clean_caption

Output:
- Mention trigger: "Abraham Lincoln"/"Lincoln" -> show with `bounce`.
- Uniform fit-to-width sizing; no deformation.

## Example 12
Input:
- Transcript: "Cleopatra ruled Egypt. Cleopatra shaped Mediterranean politics."
- Media image_1 about: "this is Cleopatra" aim: "want pop animation"
- Background: roman_columns, Design: meme_caption

Output:
- Mention trigger: "Cleopatra" -> `image_1` with `pop`.
- Width-bound fill with locked aspect ratio.

## Example 13
Input:
- Transcript: "Alexander the Great built a vast empire. Alexander changed warfare."
- Media image_1 about: "this is Alexander the Great" aim: "want shake animation"
- Background: grain_vignette, Design: clean_caption

Output:
- Mention trigger: "Alexander the Great"/"Alexander" -> `image_1` with `shake`.
- Use uniform upscale to touch left/right boundaries.

## Example 14
Input:
- Transcript: "Isaac Newton formulated gravity. Newton transformed science."
- Media image_1 about: "this is Isaac Newton" aim: "want wiggle animation"
- Background: clean_black, Design: clean_caption

Output:
- Mention trigger: "Isaac Newton"/"Newton" -> show with `wiggle`.
- Keep proportional scale; fill horizontal width.

## Example 15
Input:
- Transcript: "Galileo challenged old astronomy. Galileo defended heliocentrism."
- Media image_1 about: "this is Galileo" aim: "want slide_right reveal"
- Background: calendar_dark, Design: meme_caption

Output:
- Mention trigger: "Galileo" -> `image_1` with `slide_right`.
- Sizing: full-width coverage, equal scale factors.

## Example 16
Input:
- Transcript: "Socrates shaped philosophy. Socrates questioned everything."
- Media image_1 about: "this is Socrates" aim: "want fade_in animation"
- Background: clean_black, Design: clean_caption

Output:
- Mention trigger: "Socrates" -> show `image_1` with `fade_in`.
- Uniform width-fill sizing.

## Example 17
Input:
- Transcript: "Joan of Arc led France. Joan became a symbol of courage."
- Media image_1 about: "this is Joan of Arc" aim: "want subtle zoom in"
- Background: grain_vignette, Design: meme_caption

Output:
- Mention trigger: "Joan of Arc"/"Joan" -> `image_1` with `subtle_zoom`.
- Width-filled, aspect-ratio-preserving scale.

## Example 18
Input:
- Transcript: "Winston Churchill led Britain in war. Churchill's speeches rallied people."
- Media image_1 about: "this is Winston Churchill" aim: "want pulse animation"
- Background: roman_columns, Design: clean_caption

Output:
- Mention trigger: "Winston Churchill"/"Churchill" -> show with `pulse`.
- Fit-to-width with uniform scaling.

## Example 19
Input:
- Transcript: "Frida Kahlo transformed self-portrait art. Frida inspired generations."
- Media image_1 about: "this is Frida Kahlo" aim: "want stomp animation"
- Background: clean_black, Design: meme_caption

Output:
- Mention trigger: "Frida Kahlo"/"Frida" -> `image_1` with `stomp`.
- Horizontal-boundary coverage, no stretch.

## Example 20
Input:
- Transcript: "Pablo Picasso reinvented modern art. Picasso changed visual language."
- Media image_1 about: "this is Pablo Picasso" aim: "want bounce animation"
- Background: calendar_dark, Design: clean_caption

Output:
- Mention trigger: "Pablo Picasso"/"Picasso" -> show with `bounce`.
- Uniform upscale to fill width.

## Example 21
Input:
- Transcript: "Rosa Parks sparked civil rights momentum. Rosa Parks changed history."
- Media image_1 about: "this is Rosa Parks" aim: "want pop animation"
- Background: grain_vignette, Design: clean_caption

Output:
- Mention trigger: "Rosa Parks" -> `image_1` with `pop`.
- Width-fill, proportional scaling.

## Example 22
Input:
- Transcript: "Martin Luther King Jr. inspired equality movements. King changed America."
- Media image_1 about: "this is Martin Luther King Jr." aim: "want shake animation"
- Background: clean_black, Design: meme_caption

Output:
- Mention trigger: "Martin Luther King Jr."/ "King" -> `image_1` with `shake`.
- Keep image proportional while filling horizontal edges.

## Example 23
Input:
- Transcript: "Napoleon rose rapidly. Napoleon reshaped Europe."
- Media image_1 about: "this is Napoleon" aim: "want wiggle animation"
- Background: roman_columns, Design: clean_caption

Output:
- Mention trigger: "Napoleon" -> `image_1` with `wiggle`.
- Scale uniformly until width is covered.

## Example 24
Input:
- Transcript: "Queen Elizabeth I strengthened England. Elizabeth shaped an era."
- Media image_1 about: "this is Queen Elizabeth I" aim: "want slide_up animation"
- Background: calendar_dark, Design: clean_caption

Output:
- Mention trigger: "Queen Elizabeth I"/"Elizabeth" -> `image_1` with `slide_up`.
- Width-fill with equal scale factors.

## Example 25
Input:
- Transcript: "Akbar expanded the Mughal empire. Akbar promoted cultural exchange."
- Media image_1 about: "this is Akbar" aim: "want slide_left animation"
- Background: grain_vignette, Design: meme_caption

Output:
- Mention trigger: "Akbar" -> show `image_1` with `slide_left`.
- Uniform upscale, no axis stretching.

## Example 26
Input:
- Transcript: "Shivaji built a resilient kingdom. Shivaji inspired resistance."
- Media image_1 about: "this is Shivaji" aim: "want fade_in reveal"
- Background: clean_black, Design: clean_caption

Output:
- Mention trigger: "Shivaji" -> `image_1` with `fade_in`.
- Fill horizontal bounds while preserving ratio.

## Example 27
Input:
- Transcript: "Florence Nightingale modernized nursing. Nightingale changed healthcare."
- Media image_1 about: "this is Florence Nightingale" aim: "want subtle zoom in"
- Background: grain_vignette, Design: clean_caption

Output:
- Mention trigger: "Florence Nightingale"/"Nightingale" -> show with `subtle_zoom`.
- Width-filled, uniform scaling.

## Example 28
Input:
- Transcript: "Alan Turing laid foundations of computing. Turing changed intelligence research."
- Media image_1 about: "this is Alan Turing" aim: "want pulse animation"
- Background: clean_black, Design: meme_caption

Output:
- Mention trigger: "Alan Turing"/"Turing" -> `image_1` with `pulse`.
- Keep proportional image, fill left-right frame boundaries.

## Example 29
Input:
- Transcript: "Katherine Johnson enabled spaceflight trajectories. Johnson changed NASA missions."
- Media image_1 about: "this is Katherine Johnson" aim: "want stomp animation"
- Background: calendar_dark, Design: clean_caption

Output:
- Mention trigger: "Katherine Johnson"/"Johnson" -> `image_1` with `stomp`.
- Use isotropic scaling to cover horizontal bounds.

## Example 30
Input:
- Transcript: "Neil Armstrong stepped on the Moon. Armstrong became iconic."
- Media image_1 about: "this is Neil Armstrong" aim: "want bounce animation"
- Background: roman_columns, Design: meme_caption

Output:
- Mention trigger: "Neil Armstrong"/"Armstrong" -> `image_1` with `bounce`.
- Uniformly scale image to horizontal edges; captions remain lower safe zone.

## Caption Timing + Grouping Examples (Appended)

### planner_caption_timing_061

Input:
```text
USER_INSTRUCTION: Keep captions precise and rhythmic with clear visual hierarchy.
ELEMENT_COMPACT:
