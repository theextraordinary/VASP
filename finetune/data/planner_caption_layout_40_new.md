# planner_caption_layout_40_new.jsonl

Total examples: 40

## planner_caption_layout_091

### Input
```text
USER_INSTRUCTION: Keep captions readable and highlight only important words inline.
ELEMENT_COMPACT:
